...
public class TableJdbcSourceTestBuilder {
  ...
  public TableJdbcSource build() {
    BoneCPPoolConfigBean boneCPPoolConfigBean = new BoneCPPoolConfigBean();
    boneCPPoolConfigBean.useCredentials = useCredentials;
    boneCPPoolConfigBean.connectionString = connectionString;
    boneCPPoolConfigBean.username = username;
    boneCPPoolConfigBean.password = password;
    boneCPPoolConfigBean.driverClassName = driverClassName;
    boneCPPoolConfigBean.driverProperties = driverProperties;
    boneCPPoolConfigBean.connectionTestQuery = connectionTestQuery;
    if (maximumPoolSize == -1) {
      boneCPPoolConfigBean.maximumPoolSize = numberOfThreads + 1;
    }

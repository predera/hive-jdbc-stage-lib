...
public class TestTableHiveJdbcSource {
  private static final Logger LOG = LoggerFactory.getLogger(TestTableHiveJdbcSource.class);
  ...
  public void testWrongSqlConnectionConfig() throws Exception {
    TableJdbcSource tableJdbcSource = new TableJdbcSourceTestBuilder( "jdbc:hive2://localhost:10000/", true, USER_NAME, PASSWORD)
        .tableConfigBeans(
            ImmutableList.of(
  ...
  public void testLessConnectionPoolSizeThanNoOfThreads() throws Exception {
    TableJdbcSource tableJdbcSource = new TableJdbcSourceTestBuilder( "hive_jdbc:db://localhost:1000", true, USER_NAME, PASSWORD)
        .tableConfigBeans(
            ImmutableList.of(
                new TableJdbcSourceTestBuilder.TableConfigBeanTestBuilder().tablePattern("testTable").build()
            )

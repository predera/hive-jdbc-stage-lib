 ...
 */
package com.streamsets.pipeline.stage.processor.Hivejdbctee;
...
public class JdbcTeeProcessor extends SingleLaneProcessor {
  ...
  protected List<ConfigIssue> init() {
    ...
    if (bonecpConfigBean.connectionString.toLowerCase().startsWith("hive_jdbc:sqlserver") && useMultiRowOp) {
  ...
  public void process(Batch batch, SingleLaneBatchMaker batchMaker) throws StageException {
    ...
    if (bonecpConfigBean.connectionString.toLowerCase().startsWith("hive_jdbc:sqlserver")) {
      perRecord = true;
    }

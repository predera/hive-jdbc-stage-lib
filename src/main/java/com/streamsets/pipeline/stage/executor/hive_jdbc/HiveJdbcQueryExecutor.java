...
public class HiveJdbcQueryExecutor extends BaseExecutor {

  private static final Logger LOG = LoggerFactory.getLogger(HiveJdbcQueryExecutor.class);

  private HiveJdbcQueryExecutorConfig config;
  private ErrorRecordHandler errorRecordHandler;

  public HiveJdbcQueryExecutor(HiveJdbcQueryExecutorConfig config) {
    this.config = config;
  }

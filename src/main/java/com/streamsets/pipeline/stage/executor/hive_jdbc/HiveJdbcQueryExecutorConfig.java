...
public class HiveJdbcQueryExecutorConfig {

  private static final Logger LOG = LoggerFactory.getLogger(HiveJdbcQueryExecutorConfig.class);
  ...
  public void init(Stage.Context context, List<Stage.ConfigIssue> issues) {
    issues.addAll(bonecpConfigBean.validateConfigs(context, issues));

...
/** {@inheritDoc} */
public class HiveJdbcSourceUpgrader extends JdbcBaseUpgrader {
  ...
  private void upgradeV2ToV3(List<Config> configs) {
    configs.add(new Config("hiveJdbcRecordType", "MAP"));
  }
  ...
  private void upgradeV6toV7(List<Config> configs) {
    ...
    configs.add(new Config("jdbcNsHeaderPrefix", "hive_jdbc."));
  }

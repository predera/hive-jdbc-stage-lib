...
@StageDef(
    ...
    upgrader = HiveJdbcSourceUpgrader.class,
    recordsByRef = true,
    resetOffset = true,
    producesEvents = true,
...
public class HiveJdbcDSource extends DSource {
  ...
  @ValueChooserModel(HiveJdbcRecordTypeChooserValues.class)
  public HiveJdbcRecordType hiveJdbcRecordType;
  ...
  @ConfigDef(
      ...
      description = "Prefix for the header attributes, used as follows: <prefix>.<field name>.<type of information>. For example: hive_jdbc.<field name>.precision and hive_jdbc.<field name>.scale",
      defaultValue = "hive_jdbc.",
      displayPosition = 210,
      group = "ADVANCED",
      dependsOn = "createJDBCNsHeaders",
      triggeredByValue = "true"
  )
  public String jdbcNsHeaderPrefix = "hive_jdbc.";

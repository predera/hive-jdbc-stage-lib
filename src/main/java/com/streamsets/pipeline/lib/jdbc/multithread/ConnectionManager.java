...
public final class ConnectionManager {
  ...
  public ConnectionManager(BoneCPDataSource bonecpDataSource) {
  ...
  private synchronized Connection getNewConnection() throws SQLException{
    Connection newConnection = boneCPDataSource.getConnection();
    connectionsToCloseDuringDestroy.add(newConnection);
    return newConnection;
  }

  /**
   * Get {@link Connection} if cached connection is null fetch a connection from {@link BoneCPDataSource}
